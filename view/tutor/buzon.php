...
if (isset($_SESSION['id'])) {
    ...
    $allReadMsgsByTutor = $tutor->allReadMsgsByTutor($_SESSION['email']);
    $allUnReadMsgsByTutor = $tutor->allUnReadMsgsByTutor($_SESSION['email']);
          ...
          <div class="table-responsive mailbox-messages">
            <table class="table table-hover table-striped">
              ...
              <tbody>
                ...
                foreach($allReadMsgsByTutor as $fila)
                {
                  $countRespuestasById = $tutor->countRespuestasById($fila['id']);
