...
if (isset($_SESSION['id'])) {
    ...
    $allTutoresByAlumno = $alumnos->allTutoresByAlumno($_SESSION['perfilAlumno']);
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="card card-primary">
            ...
            <input type="hidden" name="curso" value="<?php echo $choosenAlumno['curso'];?>">
            <input type="hidden" name="tutor1" value="<?php echo $choosenAlumno['tutor1'];?>">
            <input type="hidden" name="tutor2" value="<?php echo $choosenAlumno['tutor2'];?>">
            <input type="hidden" name="img" value="<?php echo $choosenAlumno['img'];?>">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="tutor1" placeholder="Tutores"  name="tutor_1" value="<?php                  
                    foreach ($allTutoresByAlumno as $tutor) {
                      echo " - " . $tutor['nombre']." ".$tutor['apellido']." ".$tutor['apellido2'] ." ";
                    }
              ...
              <div class="card-footer">
                <button type="submit" name="enviar" class="btn btn-primary" value="updateAlumnoFromTutor">Enviar</button>
              </div>
            </form>
          </div>
        <!-- /.col -->
