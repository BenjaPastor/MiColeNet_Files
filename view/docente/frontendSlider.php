    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0 text-dark">Gestionar Área Slider</h1>
                    </div><!-- /.col -->
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12 mt-1">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Gestión Área Slider </h3>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <form action="../../Controller/frontendCtrl.php?updateSlider=1" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="logo" value="<?php echo $infoFrontEnd['slider_img']; ?>">
                                        <div class="col-md-12">
                                            <div class="col-sm-12 m-2">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <label>Título Slider<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Título Slider"
                                                        value="<?php echo $infoFrontEnd['slider_title'] ?>" name="slider_titulo" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 m-2">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <label>SubTítulo Slider<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        placeholder="SubTítulo Slider"
                                                        value="<?php echo $infoFrontEnd['slider_subtitle'] ?>" name="slider_subtitlo">
                                                </div>
                                            </div>                          <div class="col-sm-12 m-2">
                                                <!-- text input -->
                                                <div class="form-group">
                                                    <label>Texto Slider<span class="text-danger">*</span></label>
                                                    <textarea class="form-control" placeholder="Texto Slider" name="slider_text" required> <?php echo $infoFrontEnd['slider_texto'] ?> </textarea>
