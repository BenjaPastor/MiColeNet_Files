    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0 text-dark">Gestionar Todas las Aulas</h1>
                    </div><!-- /.col -->
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <button type="button" class="btn btn-primary btn-block mb-3" data-toggle="modal"
                            data-target="#addModal">Nueva Aula
                        </button>
                        <?php }?>
                        <!-- Modal Add -->
                        <div class="modal fade" id="addModal"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form
                                        action="../../Controller/aulaCtrl.php?addAula=1"
                                        method="post">
                            ...
                            <div class="col-md-12 mt-1">
                                <div class="card card-primary card-outline">
                                    ...
                                    <div class="card-body p-0">
                                            ...
                                            <table class="table table-hover table-striped">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <?php if ($isDocenteAdmin['is_admin'] == 1) {
                                                            echo "<th>Editar Aula</th>";
                                                            echo "<th>Borrar Aula</th>";
                                                        }?>
                                                    </tr>
                                                    <?php
                                                foreach ($allInfoAulas as $aula) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="mailbox-answers">
                                                            <?php echo htmlentities($aula['nombre'], ENT_QUOTES, 'UTF-8'); ?>
                                                        </td>
                                                        ...
                                                        <td><button type="button" class="btn btn-primary"
                                                                data-toggle="modal"
                                                                data-target="#editarModal<?php echo $aula['id'] ?>">
                                                                Editar
                                                            </button></td>

                                                        <td><button type="button" class="btn btn-primary"
                                                                data-toggle="modal"
                                                                data-target="#deleteModal<?php echo $aula['id'] ?>">
                                                                Eliminar
                                                            </button></td>
                                                        <?php
}?>
                                                    ...
                                                    <!-- Modal Editar -->
                                                    <div class="modal fade" id="editarModal<?php echo $aula['id'] ?>"
                                                        tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="../../Controller/aulaCtrl.php?updateAula=<?php echo $aula['id'] ?>"
                                                                    method="post">
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <label for="nombre"
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                name="nombre"
                                                                                value="<?php echo $aula['nombre'] ?>" required>
                                        ...
                                        <!-- Modal Delete -->
                                        <div class="modal fade" id="deleteModal<?php echo $aula['id'] ?>"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="../../Controller/aulaCtrl.php?delAula=<?php echo $aula['id'] ?>"
