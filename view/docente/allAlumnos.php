    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0 text-dark">Gestiónar Todos los Alumnos</h1>
                    </div><!-- /.col -->
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <button type="button" class="btn btn-primary btn-block mb-3" data-toggle="modal"
                            data-target="#addModal">Nuevo Alumno
                        </button>
                        <?php }?>
                        ...
                        <div class="modal fade" id="addModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="../../Controller/perfilAlumnoCtrl.php?allAlumnos&addAlumno=1" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="NIF" class="col-form-label">NIF:<span class="text-danger">*</span></label>
                                                ...
                                                <input type="text" class="form-control" name="apellido2" value="" >
                                                <label for="fecha_nacimiento" class="col-form-label">Fecha
                                                ...
                                                <label for="tutor1" class="col-form-label">Persona Contacto:<span class="text-danger">*</span></label>
                                                <select class="form-control form-control-sm" id="tutor1" name="tutor1">
                                                ...
                                                <label for="tutor2" class="col-form-label">Persona Contacto Alternativa:</label>
                                                <select class="form-control form-control-sm" id="tutor1" name="tutor2">
                                                <option>- Seleccione - </option>
                                                ...
                                                <label for="curso" class="col-form-label">Curso:<span class="text-danger">*</span></label>
        ...
        ?>
                                            <tr>
                                                ...
                                                <td><a href="/Controller/perfilAlumnoCtrl.php?horarioAlumno=<?php echo $alumno['id'] ?>"
                                                        class="btn btn-primary btn-block mb-3" role="button">Horario/Asistencia
                                                        </a></td>
                                            ...
                                            <div class="modal fade" id="editarModal<?php echo $alumno['id'] ?>"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            action="../../Controller/perfilAlumnoCtrl.php?allAlumnos&updateFromDocente=<?php echo $alumno['id'] ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <label for="nif"
                                                                    ...
                                                                    <label for="tutor1"
                                                                        class="col-form-label">Persona de Contacto:<span class="text-danger">*</span></label>
                                                                    ...
                                                                    <label for="tutor2"
                                                                        class="col-form-label">Persona de Contacto Alternativa:</label>
                                                                    <select class="form-control form-control-sm"
